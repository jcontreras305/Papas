...
Public Class MetodosClientes
    ...
    Public Sub actualizar_cliente(ByVal datosNuevosClientes As List(Of String))
        Try
            ...
            cmd.Parameters.AddWithValue("@estatus", datosNuevosClientes.ElementAt(5))
            cmd.Parameters.AddWithValue("@nombreContacto", datosNuevosClientes.ElementAt(6))
            cmd.Parameters.AddWithValue("@genero", datosNuevosClientes.ElementAt(7))
            cmd.Parameters.AddWithValue("@direccion", datosNuevosClientes.ElementAt(8))
            cmd.Parameters.AddWithValue("@telefono", datosNuevosClientes.ElementAt(9))
            cmd.Parameters.AddWithValue("@email", datosNuevosClientes.ElementAt(10))
            cmd.Parameters.AddWithValue("@estado", datosNuevosClientes.ElementAt(11))
            cmd.Parameters.AddWithValue("@municipio", datosNuevosClientes.ElementAt(12))
            cmd.Parameters.AddWithValue("@codigoPostal", datosNuevosClientes.ElementAt(13))
            Dim limcredi As String = Replace(datosNuevosClientes.ElementAt(14), ",", ".")
            cmd.Parameters.AddWithValue("@limiteCredito", limcredi)
            cmd.Parameters.AddWithValue("@diasCredito", datosNuevosClientes.ElementAt(15))
