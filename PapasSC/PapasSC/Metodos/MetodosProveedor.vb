...
Public Class MetodosProveedor
    ...
    Public Sub Actualizar_Proveedor(ByVal datosProveedorNuevo As List(Of String))
        Try
            ...
            cmd.Parameters.Add("@direccion2", SqlDbType.VarChar, 100).Value = datosProveedorNuevo.ElementAt(11)
            cmd.Parameters.Add("@telefono2", SqlDbType.VarChar, 12).Value = datosProveedorNuevo.ElementAt(12)
            cmd.Parameters.Add("@email2", SqlDbType.VarChar, 100).Value = datosProveedorNuevo.ElementAt(13)
