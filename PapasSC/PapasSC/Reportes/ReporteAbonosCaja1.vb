...
Public Class ReporteAbonosCaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PapasSC.ReporteAbonosCaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteAbonosCaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteAbonosCaja = New ReporteAbonosCaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
