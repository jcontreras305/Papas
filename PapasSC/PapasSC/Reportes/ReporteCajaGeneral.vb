...
Public Class ReporteCajaGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PapasSC.ReporteCajaGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteCajaGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteCajaGeneral = New ReporteCajaGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
