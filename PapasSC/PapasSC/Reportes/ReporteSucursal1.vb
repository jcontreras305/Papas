...
Public Class ReporteSucursal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PapasSC.ReporteSucursal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NombreSucursal() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteSucursal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteSucursal = New ReporteSucursal()
        rpt.Site = Me.Site
        Return rpt
    End Function
